...
@app.callback(
    ...
    , [Input('table-sorting-filtering', "page_current"), Input('table-sorting-filtering', "page_size")
        , Input('table-sorting-filtering', 'sort_by'), Input('table-sorting-filtering', 'filter_query')
        , Input('Last_Decade', 'value'), Input('year-slider', 'value'), Input('Artist-drop', 'value')])
